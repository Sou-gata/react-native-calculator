...
import { avgAnsTye, colorSchemeType, inputsType } from "../../types";
...
const Average = () => {
    ...
    const [solutionText, setSolutionText] = useState<avgAnsTye>({
        arithmetic: { text: "", avg: "" },
        geometric: { text: "", avg: "" },
        harmonic: { text: "", avg: "" },
    });
    const arithrmeticSolutionText = () => {
        ...
        setSolutionText((prev) => ({
            ...prev,
            arithmetic: { ...prev.arithmetic, text, avg: avg.toString() },
        }));
    };
    const geometricSolutionText = () => {
        ...
        setSolutionText((prev) => ({
            ...prev,
            geometric: { text, avg: avg.toString() },
        }));
    };
    const harmonicSolutionText = () => {
        ...
        for (let i = 0; i < inputs.length; i++) {
            ...
            if (!hasZero) {
                ...
                setSolutionText((prev) => ({
                    ...prev,
                    harmonic: { text: "", avg: avg.toString() },
                }));
            }
        }
    };
                ...
                <ScrollView
                    ...
                    <View style={{ paddingTop: 10 }}>
                        ...
                        <View
                            ...
                            <Fraction
                                color={colors.text}
                                numerator={inputs.length.toString()}
                                denominator={
                                    <HarmonicAnswer
                                        inputs={inputs}
                                        color={colors.text}
